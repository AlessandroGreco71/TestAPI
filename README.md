# Tap OpenAPI Specification
[![Build Status](https://travis-ci.org/AlessandroGreco71/TestAPI.svg?branch=master)](https://travis-ci.org/AlessandroGreco71/TestAPI)
...
6. If you did everything correct, https://alessandrogreco71.github.io/TestAPI/ will lead to your new docs
...
- Documentation(ReDoc): https://alessandrogreco71.github.io/TestAPI/
- SwaggerUI: https://alessandrogreco71.github.io/TestAPI/swagger-ui/
- Look full spec:
    + JSON https://alessandrogreco71.github.io/TestAPI/swagger.json
    + YAML https://alessandrogreco71.github.io/TestAPI/swagger.yaml
- Preview spec version for branch `[branch]`: https://alessandrogreco71.github.io/TestAPI/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://alessandrogreco71.github.io/TestAPI/ with url from the message: `Server started <url>`
